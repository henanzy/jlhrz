...
<div id="ssqx2" ></div>
	<div id="" class="clearfix" style="overflow-x: hidden;">
		...
		<div class="mws-panel grid_8"
				style="width:95%;min-width: 500px;">
			...
			<div class="mws-panel grid_8"
				...
				<div>
					<!-- <div class="mws-panel-content"> -->
					<div id="container"  style="width:90%; height:450px;float:left;" >
					</div>
					
				<div  style="width:10%; height:450px;float:left; " >
	       ...
	       <div class="mws-panel grid_8"
				...
				<div class="mws-panel-body">
				   ...
				   <div  class="mws-panel-body"  style="width:100%;">
					<div  style="width:90%; height:380px;float:left;" >
					<div id="Lcontainer" style="width: 100%; height: 380px;"></div>
				   </div>
				   
				   <div  style="width:10%; height:380px;float:left; " >
	...
	var chart = Highcharts.chart('ssqx2', {
		chart: {
			type: 'spline',
			marginRight: 10,
			events: {
			...
			data: (function () {
				...
				var data1 = [];
				 $.ajax({
				 		...
				 		success : function(data) {
				 			data1=data.selHis;//数据填充到highcharts上面  */
				 		}
				 	});
				var data=data1;
				console.log(data);
...
var chart = Highcharts.chart('ssqx', {
	chart: {
		type: 'spline',
		marginRight: 10,
		events: {
